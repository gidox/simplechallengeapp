...
import { Button, Dialog, TouchableRipple, Subheading, Text, Portal, RadioButton, Caption, ActivityIndicator, Appbar, Snackbar} from "react-native-paper";
...
const AddClient = ({ navigation }: LoginProps) => {
  ...
  async function handleCreateClients(values, actions) {
    ...
    try {
      ...
      actions.resetForm()
      setCity({});
      phoneRef.current.state.inputValue = '';
  ...
  return (
    <Portal>
      <Appbar.Header>
        ...
        <Appbar.Content title="Agregar Cliente" />
      </Appbar.Header>
              ...
              <>
                ...
                <View style={styles.buttonContainer}>
                  <Button
                    ...
                    disabled={!isValid || !citySelected.id || !subsidiarySelected.id || isSubmitting || (phoneRef.current && !phoneRef.current.isValid())}
                    mode='contained'
